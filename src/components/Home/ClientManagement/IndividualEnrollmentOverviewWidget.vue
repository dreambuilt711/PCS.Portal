<template>
  <div id="individualEnrollmentOverviewWidget" />
</template>
...
export default {
  ...
  setup(props) {
    ...
    function loadIndividualClientDetails() {
      ...
      var centerCount = formatNumber(donutCountData.value[0].Count)
      let divWidth = document.getElementById('individualEnrollmentOverviewWidget')
      ...
      var legendSpacing = 4
      d3.select('#individualEnrollmentOverviewWidget').selectAll('svg').remove()
      ...
      var svg = d3
        .select('#individualEnrollmentOverviewWidget')
        .append('svg')
        .attr('width', width)
        .attr('height', height)
        .append('g')
